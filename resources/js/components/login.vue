        ...
        <form action method="post" class="px-2 sm:px-0">
          <div class="flex flex-col items-start mb-6">
            ...
            <input
              ...
              name="username"
              v-model="username"
              class="w-full h-10 border-2 border-blue-500 focus:shadow-outline rounded-tr sm:rounded-tr-full rounded-bl sm:rounded-bl-full sm:pl-6"
            />
          </div>
          <div class="flex flex-col items-start mb-6">
          ...
          <div class="flex flex-col items-start mb-6">
            <input
              ...
              name="login"
              @click.prevent="login"
              class="border-blue-400 border-2 px-12 py-2 rounded-bl-full rounded-tr-full bg-teal-500 hover:bg-blue-500 text-white"
              value="Login"
            />
          </div>
        </form>
        <button class="px-4 py-2 bg-blue-500 text-white rounded" @click="showadmin=true">Admin</button>
      </div>
      <div v-else>
